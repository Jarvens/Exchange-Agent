...
func init() {
	proto.RegisterType((*RpcResponse1)(nil), "grpc.RpcResponse1")
	proto.RegisterType((*RpcRequest1)(nil), "grpc.RpcRequest1")
}
...
func (c *rpcBidStream1Client) QuoteBidStream(ctx context.Context, opts ...grpc.CallOption) (RpcBidStream1_QuoteBidStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &_RpcBidStream1_serviceDesc.Streams[0], "/grpc.RpcBidStream1/QuoteBidStream", opts...)
	if err != nil {
		return nil, err
	}
...
var _RpcBidStream1_serviceDesc = grpc.ServiceDesc{
	ServiceName: "grpc.RpcBidStream1",
